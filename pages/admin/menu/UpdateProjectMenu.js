...
const UpdateProjectMenu = ({ id }) => {
    ...
    useEffect(() => {
        ...
        const exampleInputPath = document.getElementById("exampleInputPath");
        ...
        form.addEventListener("submit", (e) => {
            ...
            fetch("http://localhost:3000/menu/" + id, {
                ...
                router.navigate("/admin/menu/projectmenu");
            });
                ...
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <form id="form-add">
                            ...
                            <div class="mb-3">
                                <label for="exampleInputPath" class="form-label">Path</label>
                                <input type="text" class="form-control"value="${data.path}" id="exampleInputPath">
                            </div>
...
export default UpdateProjectMenu