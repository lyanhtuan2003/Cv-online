...
const UpdateProjectContact = ({ id }) => {
    ...
    useEffect(() => {
        ...
        const exampleInputSubject = document.getElementById("exampleInputSubject");
        const exampleInputMessage = document.getElementById("exampleInputMessage");
        ...
        form.addEventListener("submit", (e) => {
            ...
            const formData = {
                ...
                subject: exampleInputSubject.value,
                message: exampleInputMessage.value
            ...
            fetch("http://localhost:3000/contact/" + id, {
                ...
                router.navigate("/admin/contact/projectcontact");
            });
                  ...
                  <div class="bg-light rounded h-100 p-4">
                      ...
                      <form id="form-add">
                          <div class="mb-3">
                              ...
                              <input type="email" class="form-control" value="${data.email}" id="exampleInputEmail1"
                          ...
                          <div class="mb-3">
                              ...
                              <input type="text" class="form-control" value="${data.subject}"id="exampleInputSubject"
                                  aria-describedby="emailHelp">
                              
                          </div>
                          <div class="mb-3">
                              <label for="exampleInputMessage" class="form-label">Message</label>
                              <input type="text" class="form-control"value="${data.message}" id="exampleInputMessage"
                                  aria-describedby="emailHelp">
...
export default UpdateProjectContact