            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">List Services</h6><a href="/admin/skill/projectskill/1/edit#/admin/skill/projectskill/add"><button class="btn btn-info m-2"> Add Service</button></a>
            ...
            .map((project, index) => {
                return `
                                <tr>
                                    ...
                                    <td><button class="btn btn-danger btn-remove m-2" data-id="${project.id}">Delete</button> <a href="/admin/skill/projectskill/${project.id}/edit"<button class="btn btn-outline-success m-2">Update</button></td>
                                </tr>
                                `;
            })
            .join("")}
