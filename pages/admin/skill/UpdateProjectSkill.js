...
const UpdateProjectSkill = ({ id }) => {
    ...
    useEffect(() => {
        ...
        const exampleInputProgress = document.getElementById("exampleInputProgress");
        ...
        form.addEventListener("submit", (e) => {
            ...
            const formData = {
                ...
                progress: exampleInputProgress.value,
            ...
            fetch("http://localhost:3000/skill/" + id, {
                ...
                router.navigate("/admin/skill/projectskill");
            });
                      ...
                      <div class="bg-light rounded h-100 p-4">
                          ...
                          <form id="form-add">
                              ...
                              <div class="mb-3">
                                  ...
                                  <input type="text" class="form-control" value="${data.progress}" id="exampleInputProgress">
                              </div>
...
export default UpdateProjectSkill