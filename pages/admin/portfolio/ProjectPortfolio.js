        ...
        <div class="container-fluid pt-4 px-4">
            <div class="col-sm-12 col-xl-12">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">List Portfolio</h6><a href="/admin/portfolio/projectportfolio/1/edit#/admin/portfolio/projectportfolio/add"><button class="btn btn-info m-2"> Add Portfolio</button></a>
            ...
            .map((project, index) => {
                return `
                            <tr>
                                ...
                                <td><img src="${project.img}" style="width:100px"></td>
                                
                                <td><button class="btn btn-danger btn-remove m-2" data-id="${project.id}">Delete</button> <a href="/admin/portfolio/projectportfolio/${project.id}/edit"<button class="btn btn-outline-success m-2">Update</button></td>
                            </tr>
                            `;
            })
            .join("")}
