            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">List Profile</h6><a href="/admin/profile/projectprofile/1/edit#/admin/profile/projectprofile/add"><button class="btn btn-info m-2"> Add Profile</button></a>
            ...
            .map((project, index) => {
                return `
                                                    <tr>
                                                        ...
                                                        <td><button class="btn btn-danger btn-remove m-2" data-id="${project.id}">Delete</button> <a href="/admin/profile/projectprofile/${project.id}/edit"<button class="btn btn-outline-success m-2">Update</button></td>
                                                    </tr>
                                                    `;
            })
            .join("")}
