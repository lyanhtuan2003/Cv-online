    ...
    useEffect(() => {
        ...
        form.addEventListener("submit", (e) => {
            ...
            fetch("http://localhost:3000/profile/" + id, {
                ...
                router.navigate("/admin/profile/projectprofile");
            });
                ...
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form id="form-add">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" value="${data.img}" id="exampleInputImage">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputposition" class="form-label">positions of experience</label>
...
export default UpdateProjectProflie