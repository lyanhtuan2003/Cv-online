...
const UpdateProjectServicess = ({ id }) => {
    ...
    useEffect(() => {
        ...
        const exampleInputLink = document.getElementById("exampleInputLink")
        form.addEventListener("submit", (e) => {
            ...
            fetch("http://localhost:3000/services/" + id, {
                ...
                router.navigate("/admin/servicess/projectservicess");
            });
                  ...
                  <div class="col-sm-12 col-xl-12">
                      <div class="bg-light rounded h-100 p-4">
                          ...
                          <form id="form-add">
                              ...
                              <div class="mb-3">
                                  <label for="exampleInputDes" class="form-label">Link</label>
                                  <input type="text" class="form-control" value="${data.linkss}" id="exampleInputLink">
                              </div>
...
export default UpdateProjectServicess