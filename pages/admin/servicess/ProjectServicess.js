...
const ProjectServicess = () => {
    const [data, setData] = useState([]);
    // chạy sau khi render

    useEffect(() => {
        // lấy dữ liệu từ localStorage
        // const projects = JSON.parse(localStorage.getItem("projectst")) || [];
        // setData(projects)
    ...
    useEffect(function () {
        ...
        for (let btn of btns) {
            ...
            btn.addEventListener("click", function () {
                ...
                // localStorage.setItem("projectst", JSON.stringify(newData));
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">List Services</h6><a href="/admin/servicess/projectservicess/1/edit#/admin/servicess/projectservicess/add"><button class="btn btn-info m-2"> Add Service</button></a>
            ...
            .map((project, index) => {
                return `
                                <tr>
                                    ...
                                    <td>${project.linkss}</td>
                                    <td><button class="btn btn-danger btn-remove m-2" data-id="${project.id}">Delete</button> <a href="/admin/servicess/projectservicess/${project.id}/edit"<button class="btn btn-outline-success m-2">Update</button></td>
                                </tr>
                                `;
            })
            .join("")}
...
export default ProjectServicess